...
class FactChecker:
    def __init__(
        ...
        self.openai_api_key = "sk-e7c495ec520b4e089d274ee996e0d476"  # Placeholder for local setup
...
""",
    ...
    def _get_embeddings(self, texts: list) -> np.ndarray:
        ...
        Handles batch size limits (e.g., Aliyun restricts batch size to 10 max).
